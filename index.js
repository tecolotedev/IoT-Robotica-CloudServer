...
app.post('/posicion',(req,res)=>{
  ...
  console.log(theta11,theta21,theta12,theta22)
  io.emit('iniciarAngulos',{theta11Server:theta11*Math.PI/180,theta21Server:theta21*Math.PI/180,theta12Server:theta12*Math.PI/180,theta22Server:theta22*Math.PI/180});
  console.log({theta11Server:theta11*Math.PI/180,theta21Server:theta21*Math.PI/180,theta12Server:theta12*Math.PI/180,theta22Server:theta22*Math.PI/180})
...
io.on('connection', (client) => { 
  ...
  // console.log({theta11Server,
  //   theta21Server,
  //   theta12Server,
  //   theta22Server})
  client.on('setNombreControlador',nombre=>{
    console.log('nombre: ',nombre);
    client.broadcast.emit('setNombreControlador',nombre);
  });
